...
func defaultModuleConfig(module string) string {
	...
	defaults := map[string]string{
		...
		"geoip":             `{"database_path":"/etc/badsector/geoip/GeoLite2-Country.mmdb","fail_open":true,"block_countries":[],"allow_countries":[],"allow_only":false,"use_header_fallback":true,"deny_action":"block","ban_threshold":5,"ban_ttl":86400,"pass_ttl":3600}`,
